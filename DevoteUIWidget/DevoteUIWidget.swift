...
struct DevoteUIWidgetEntryView : View {
...
struct DevoteUIWidget: Widget {
    let kind: String = "DevoteUIWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(iOS 17.0, *) {
                DevoteUIWidgetEntryView(entry: entry)
        ...
        .configurationDisplayName("DevoteUI Launcher")
